export default function BooksIcon(props) {
    return (<svg class={props.class} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
	...
	"/>
      ...
      <polygon style="fill:#D5681E;" points="225.014,50.104 163.846,50.104 142.948,258.09 163.846,461.892 225.014,461.892 
	225.014,222.901 214.565,207.235 225.014,191.557 "/>
      <polygon style="fill:#FF9933;" points="102.68,50.104 102.68,191.557 113.129,207.235 102.68,222.901 102.68,461.892 
	163.846,461.892 163.846,50.104 "/>
      ...
      <polygon style="fill:#FF8E00;" points="447.144,114.286 408.337,122.005 395.915,139.902 407.188,297.583 454.828,436.077 
	473.191,448.058 512,440.338 "/>
      <polygon style="fill:#FFBA00;" points="338.783,135.84 403.639,461.892 442.447,454.173 454.828,436.077 395.915,139.902 
	377.591,128.121 "/>
      <rect x="259.164" y="272.418" transform="matrix(-0.1951 -0.9808 0.9808 -0.1951 225.8253 761.5127)" style="fill:#FDE09C;" width="332.45" height="31.347"/>
    </svg>);
}
